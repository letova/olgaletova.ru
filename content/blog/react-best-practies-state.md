...
React-разработчики, заключается в том, что фрагменты данных помещаются в React
...
Если у нас достаточно простой компонент, можно мемоизировать сами строки, но при
сложной внутренней логике и большом количестве зависимостей для `rows` такое
...
- можем ли мы сохранить состояние в другом месте?

- правильные ли мы данные храним в состоянии?

- не дублируются ли у нас одни и теже данные в разных переменных состояния?
